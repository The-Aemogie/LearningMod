...
import com.theaemogie.learnmod.common.block.interfaces.IDoubleBlock;
...
import static com.theaemogie.learnmod.common.block.voxels.ChairVoxel.Occlusion;
...
public class ChairBlock extends AbstractSeatBlock implements IDoubleBlock {
    ...
    public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
        ...
        if (half == DoubleBlockHalf.LOWER) {
            ...
            switch (direction) {
                case NORTH:
                    return Occlusion.NORTH_UPPER_FULL;
                case EAST:
                    return Occlusion.EAST_UPPER_FULL;
                //                return Rotate.rotateShape(Direction.NORTH, Direction.EAST, ChairVoxel.GET);
                case SOUTH:
                    return Occlusion.SOUTH_UPPER_FULL;
                //                return Rotate.rotateShape(Direction.NORTH, Direction.SOUTH, ChairVoxel.GET);
                case WEST:
                    return Occlusion.WEST_UPPER_FULL;
                default:
                    return null;
            }
        }
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult subBlockPos) {
        ...
        return super.use(state, world, pos, player, hand, subBlockPos);
    }
}