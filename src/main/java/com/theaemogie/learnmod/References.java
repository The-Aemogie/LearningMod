...
public class References {
    ...
    public static final ItemGroup GLASS_LIGHT_GROUP = new LearnModGroups.GlassLightGroup(MOD_ID + ".glass_lights");
    public static final ItemGroup CHAIR_GROUP = new LearnModGroups.ChairGroup(MOD_ID + ".chairs");
